...
4. Запустить SensorServer на смартфоне (в настройках указать sampling rate: 40000 микросекунд, что соответствует 25 герцам указанным в скрипте) и вбить IP адрес который он сообщит в скрипт, в переменную address класса TMyApplication, в формате, который там предлагается.
...
7. Запустить скрипт main.py на Linux и лечь спать на спину, положив смартфон на грудь, в районе мечевидного отростка или чуть ниже ;)
